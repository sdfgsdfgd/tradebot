...
class FiltersConfig:
    ...
    regime2_soft_bear_branch_a_slope_med_slow_min_pct: float | None = None
    regime2_soft_bear_branch_a_slope_vel_slow_min_pct: float | None = None
...
class StrategyConfigBase:
    ...
    regime2_bear_entry_mode: str = "off"
    regime2_bear_allow_long_recovery: bool = True
    regime2_bear_supertrend_atr_period: int | None = None
    regime2_bear_supertrend_multiplier: float | None = None
    regime2_bear_supertrend_source: str | None = None
    ...
    regime2_transition_hot_shock_atr_pct_min: float | None = None
    regime2_transition_hot_release_max_bars: int | None = None
    regime2_upcorridor_branch_a_long_mid_shock_atr_pct_min: float | None = None
    regime2_upcorridor_branch_a_long_mid_shock_atr_pct_max: float | None = None
    regime2_upcorridor_branch_a_long_extreme_shock_atr_pct_min: float | None = None
    regime2_upcorridor_branch_a_long_fresh_release_age_max_bars: int | None = None
    regime2_upcorridor_branch_a_long_stale_release_age_min_bars: int | None = None
    regime2_upcorridor_branch_b_long_stale_release_age_min_bars: int | None = None
    regime2_upcorridor_branch_b_long_flat_low_shock_atr_pct_max: float | None = None
    regime2_upcorridor_branch_b_long_flat_low_stale_release_age_min_bars: int | None = None
    regime2_upcorridor_branch_b_long_flat_shock_atr_pct_max: float | None = None
    regime2_upcorridor_branch_b_long_flat_ddv_abs_max_pp: float | None = None
    regime2_trenddown_branch_b_long_hard_up_release_age_min_bars: int | None = None
    regime2_trenddown_branch_b_long_hard_up_release_age_max_bars: int | None = None
    regime2_trenddown_branch_b_long_hard_up_shock_atr_pct_min: float | None = None
    regime2_trenddown_branch_b_long_hard_up_shock_atr_pct_max: float | None = None
    regime2_trenddown_branch_b_long_hard_up_ddv_min_pp: float | None = None
    regime2_trenddown_branch_b_long_hard_up_ddv_max_pp: float | None = None
    regime2_trenddown_branch_b_long_hard_up_recovery_shock_atr_pct_min: float | None = None
    regime2_trenddown_branch_b_long_hard_up_recovery_shock_atr_pct_max: float | None = None
    regime2_trenddown_branch_b_long_hard_up_recovery_ddv_min_pp: float | None = None
    ...
    regime2_clean_host_bear_supertrend_multiplier: float | None = None
    regime2_clean_host_bear_hard_supertrend_multiplier: float | None = None
    regime2_bear_hard_mode: str = "off"
    regime2_bear_hard_bar_size: str | None = None
    regime2_bear_hard_supertrend_atr_period: int | None = None
    regime2_bear_hard_supertrend_multiplier: float | None = None
    regime2_bear_hard_supertrend_source: str | None = None
    ...
    spot_guard_threshold_scale_tr_ref: float | None = None
    spot_guard_threshold_scale_atr_vel_ref_pct: float | None = None
    spot_guard_threshold_scale_tr_median_ref_pct: float | None = None
    ...
    spot_flip_hold_dynamic_mode: str | None = None
    spot_flip_hold_dynamic_min_mult: float = 0.50
    spot_flip_hold_dynamic_max_mult: float = 2.50
    spot_flip_hold_dynamic_tr_ref: float | None = None
    spot_flip_hold_dynamic_atr_vel_ref_pct: float | None = None
    spot_flip_hold_dynamic_tr_median_ref_pct: float | None = None
