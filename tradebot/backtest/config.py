...
def _strategy_schema_common() -> dict[str, _FieldSpec]:
    return {
        ...
        "top_level_host_router_mode": _field(_identity, "off"),
        "top_level_host_router_fast_window_days": _field(lambda value: _parse_positive_int(value, default=63), 63),
        "top_level_host_router_slow_window_days": _field(lambda value: _parse_positive_int(value, default=126), 126),
        "top_level_host_router_min_dwell_days": _field(lambda value: _parse_positive_int(value, default=10), 10),
