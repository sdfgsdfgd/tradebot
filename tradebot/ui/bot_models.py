...
class _BotInstance:
    ...
    prewarm_wait_logged: bool = False
...
class _SignalSnapshot:
    ...
    shock_detector: str | None = None
    shock_direction_source_effective: str | None = None
    shock_scale_detector: str | None = None
    shock_dir_ret_sum_pct: float | None = None
    shock_atr_pct: float | None = None
    shock_drawdown_pct: float | None = None
    ...
    shock_dir_up_streak_bars: int | None = None
