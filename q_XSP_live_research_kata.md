...
| Observer cadence | Both five-minute timers are active. The scheduled `15:12Z` Hawkeye checkpoint found both selected runs flat/clean with zero submissions/P&L/DD/breaches. After SPY extended the cold-start rise to `757.87`, the `15:10Z` four-horizon owner emitted a real down turn/proposal; v3 rejected it only because retrace was `1.093 ATR < 1.25`, not because of warmup. Gold retained H4/D1 down without a fresh turn |
...
- `[INCUBATING 4/6]` **XSP financed cold-start adoption:** prospectively
  ...
  specimen then emitted an opposite raw turn before v3's `12`-bar minimum
  ownership would have released a hypothetical adoption, so complete lifecycle
  giveback—not merely entry MFE—is the decisive replay burden.
- `[INCUBATING 4/6]` **Tri-asset narrative-dispersion compression:** test
