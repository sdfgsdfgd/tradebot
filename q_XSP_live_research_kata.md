...
| D-193 | the Stage-87 velocity-ignition ladder is the sole seconds-tight onset timing hypothesis. Fixed 5/15/30/60-second intervals may eventually choose chase, unchanged maturation, or fake-turn rejection only after unseen bidirectional/route cohorts, matched controls, and sealed economics pass. It may never invent direction, suppress raw-turn risk reduction, infer depth/intent from L1, resize capital, or claim colocated HFT authority |
