...
| Goal snapshot | authoritative attachment SHA `ea08f3fe…` is read in full; `q_XSP_goal_objective.md` (`bf374b8c…`) is its tracked backup. Both explicitly require autonomous ideal-safe decisions, all-three Hawkeye/profitability continuity, continued multi-week sharpening, and no routine decision blocking. The attachment owns the Goal while this kata remains the detailed resume authority |
