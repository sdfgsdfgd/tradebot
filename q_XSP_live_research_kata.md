...
| Observer cadence | **recovered:** q is clean, state owner `643b6a…` remains byte-identical, terminal restart passed, and the first natural new-day GTH recurrences evaluated successfully with exact persisted daily-context and SPY-proxy provenance. July 29 remains exactly one closed trade and flat; selection/order authority remain absent |
