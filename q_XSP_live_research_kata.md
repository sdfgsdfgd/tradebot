...
| E-308 | v3 selection now requires its wrapper-forced fresh read-only RTH checkpoint to contain E-307's canonical causal context, with matching decision day, strictly prior `as_of_day`, state fingerprint, and exact `5/10/21/42/63/84` window/velocity/acceleration horizons. The selected identity retains those dates and fingerprint; missing, altered, noncausal, wrong-day, incomplete, or re-addressed evidence fails before authority. Focused selection/runtime/calibration proof passes `140/140`; full suite `968 passed, 4 deselected`. Signal owner, cash math, ladder, orders, and clock remain unchanged |
