...
24. `[WIP]` Sharpen the MCL Two-Speed Auction Relay through the user-authorized
    ...
    V17 freezes an independent energy-curvature router: positive raw-turn ATR
    acceleration follows a `1–3` tick response, otherwise it fades; OR/AND the
    fixed three-horizon breadth are semantic neighbors only.
